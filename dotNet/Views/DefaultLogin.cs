...
{
    public partial class DefaultLogin : UserControl, IAction
    {
        ...
        private bool Login(string EMAIL, string ACCESS_NUMBER, string AUTO_LOGIN_ACCESS_NUMBER, bool AUTO_LOGIN)
        {
            ...
            try
            {
                ...
                result = this.Search(new DefaultLoginSearchModel()
                {
                    EMAIL = EMAIL,
        ...
        private void Language_SelectedIndexChanged(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                this.Translator().TargetCultureName = comboBox.Text;
